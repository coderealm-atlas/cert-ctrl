...
if(USE_MSBUILD)
    ...
    set(CONFIGURE_MODE)
    set(CONFIGURE_OPTIONS_DEBUG)
    set(CONFIGURE_OPTIONS_RELEASE)
    if(VCPKG_TARGET_IS_MUSL)
        # vcpkg-make 2026-07-09 drops its generated default configure
        # options for this native musl triplet. Without explicit prefixes,
        # Autoconf installs into DESTDIR/usr/local and pkg-config validation
        # cannot find libsodium.pc.
        set(CONFIGURE_MODE DISABLE_DEFAULT_OPTIONS)
        set(CONFIGURE_OPTIONS_DEBUG "--prefix=${CURRENT_INSTALLED_DIR}/debug")
        set(CONFIGURE_OPTIONS_RELEASE "--prefix=${CURRENT_INSTALLED_DIR}")
        if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
            list(APPEND OPTIONS --enable-shared --disable-static)
        else()
            list(APPEND OPTIONS --disable-shared --enable-static)
        endif()
    endif()
